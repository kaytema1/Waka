        ...
        <%
            ...
            try {
                ...
                if (searchid.equalsIgnoreCase("fullname")) {
                   ...
                   list = mgr.getPatientByName(fname, lname);
...
<%if(list != null){%>
                    ...
                    <div style="display: none;" class="span9 offset3 thumbnail well content1 hide">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="display example table">
                            ...
                            <tbody>
                                ...
                                %>
                                <tr class="odd gradeX">
                                    <td class="patient" rel="popover" data-original-title="<span style='text-align:center;'> <h3>Patient Information Summary </h3> <h5> <b><%= pp.getLname()%> </b>,  <%= pp.getFname()%>  </h5> <h5><b> Date of Birth :</b> <%= pp.getDateofbirth()%></h5> <span>"
                                        ...
                                        </table>"><a class="patientid"><%= pp.getPatientid()%></a></td><td><b><%= pp.getLname()%> </b>,  <%= pp.getFname()%> <td><%= mgr.sponsorshipDetails(pp.getPatientid()).getType()%></td><td>  <%= pp.getDateofbirth()%> </td>
       ...
       <%for(int i=0;i<list.size();i++){ 
                                ...
                                %>
                                <div style="max-height: 600px; y-overflow: scroll; display: none;" class="usersummary hide" id="<%= ppp.getPatientid()%>"  title="Patient Information">
            <div class="well thumbnail">
                <ul style="margin-left: 0px;" class="breadcrumb">
                    <li>
                        <span class="divider"></span> Folder No: <%= p.getPatientid()%>
                ...
                <form class="span3" style="text-align: center; margin-left: 25%; "  action="action/forwardaction.jsp" method="post">
                    Send <b><%= ppp.getFname()%> <%= ppp.getLname()%></b> to;
                    <select name="unitid" onchange="updateView()">
                        <%
                            List units = mgr.listUnits();
