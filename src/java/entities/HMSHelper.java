...
public class HMSHelper {
   ...
   /* public Folder createFolder(String foldernumber, String shelvenumber, String status, String previouslocation) {
    ...
    public List listNhisTreatment() {
     ...
     public List getPatientByName(String fname, String lname) {
        System.out.println("here"+fname);
        session = HibernateUtil.getSessionFactory().getCurrentSession();
        session.beginTransaction();
        List result = session.createQuery("from Patient where fname = 'fname' or lname = 'lname' or fname = 'lname' or lname = 'fname'").list();
        session.getTransaction().commit();
        return result;
    } 
    ...
    public Patientinvestigation updatePatientInvestigation(int ptid, String result, String yes) {
        session = HibernateUtil.getSessionFactory().getCurrentSession();
        session.beginTransaction();
