                                            ...
                                            <div class="dialog" id="<%=vst.getVisitid()%>_dialog" title="Accounts">
                                                ...
                                                <div style="margin-left: 0px;" class="span2 ">
                                                    <ul class="menu">
                                                        ...
                                                        <li> <a class="registration_link active"> <i class="icon-white icon-list-alt"> </i> Registration </a></li>
                                                        <li> <a class="consultation_link"> <i class="icon-white icon-list-alt"> </i> Consultation </a></li>
                                                        <li> <a class="laboratory_link"> <i class="icon-white icon-list-alt"> </i> Laboratory </a></li>
                                                        <li> <a class="pharmacy_link"> <i class="icon-white icon-list-alt"> </i> Pharmacy </a></li>
                                                    </ul>
                                                </div>

                                                <div class="well thumbnail span7 pull-right">
