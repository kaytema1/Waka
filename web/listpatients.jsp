                        ...
                        <div style="padding-bottom: 80px; " class="span9 thumbnail well content">
                            ...
                            <table class="example display">
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <td class="patient" rel="popover" data-original-title="<span style='text-align:center;'> <h3>Patient Information Summary </h3> <h5> <%=patient.getFname()%> <%=patient.getLname()%> </h5> <h5><b> Date of Birth :</b>  <%=patient.getDateofbirth()%></h5> </span>"
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="first_half">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" name="lname"  id="input01" value="<%=patient.getLname()%>"/>
                                                                    <p class="help-inline">
                                                            ...
                                                            <div class="control-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" name="midname"  id="input01" value="<%=patient.getMidname()%>"/>
                                                                    <p class="help-inline">
