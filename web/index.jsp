                    ...
                    <div  style="float: left;" class="second">            
                                ...
                                <div class="controls">
                                    ...
                                    <select name="company">
                                        <%
                                            ...
                                            List Sponsors2 = mgr.listSponsors();
                                            for (int i = 0; i < Sponsors2.size(); i++) {
                                                Sponsorship sponsor = (Sponsorship) Sponsors2.get(i);
                                        %>
                        ...
                        <div style="display:none;" id="nhisdiv">
                            <div class="control-group">
                                <label class="control-label" >Membership ID</label>
                                <div class="controls">
                                    <input type="text" id="inputSuccess"name="nhismembershipid" for="inputSuccess" value="NA"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
                        </div>
